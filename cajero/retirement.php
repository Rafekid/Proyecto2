...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["account"]) && !empty($_POST["account"]) && isset($_POST["amount"]) && !empty($_POST["amount"])) {
        $error = CajeroController::instance()->retirement($_POST["account"], $_POST["amount"]);

        if (empty($error)) {
            $_SESSION["success"] = "Se ha realizado el retiro de la cuenta " . $_POST["account"];
...
<body>
    ...
    <div class="login_container">
        ...
        <h1 class="text-center main-color">Retiro Monetario </h1>
        ...
        <form action="retirement.php" method="POST" autocomplete="off">
            ...
            <div class="form-group">
                <label for="">Monto a debitar: </label>
